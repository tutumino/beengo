...
<head>
    ...
    <script type="text/javascript" src="js/validate_index.js"></script>
...
var titleSample = 'イベント名（必須）';
inputSample('#title', titleSample);

var nameSample = 'あなたのお名前（必須）';
inputSample('#master_name', nameSample);

var descSample = 'イベントの概要、詳細、コメントなど';
inputSample('#description', descSample);

var passSample = 'パスワード（半角英数16文字以内）';
inputSample('#pass', passSample);

var passSample2 = 'パスワード（再入力）';
inputSample('#pass2', passSample2);
...
<div id="top_area">
    ...
    <div id="top" class="clearfix">
        ...
        <div id="catch">
            ...
            <h2>忙しい幹事さんへ。<br />イベント案内、日程調整を、<br />もっとスマートに。</h2>
        ...
        <div id="appeal_boxes" class="clearfix">
            <div class="appeal_box shadow">
                ...
                <p>幹事を引き受けて、意外と大変なのが日程調整。Beengo（ビーンゴ）なら、イベント概要と日時候補をサクサクと入力して「イベントページ」を作成し、それを参加メンバーに教えてあげるだけ。</p>
                <p>参加メンバーは「イベントページ」で参加可能な日時にチェックを入れるだけ。すると、マスターページ（幹事用のページ）で、どの日時がイベント開催に最適なのかが一目でわかる表が自動的にできあがります。</p>
            </div><!--<appeal_box>-->
            <div class="appeal_box shadow">
                <h3>イベント告知、<br />日時決定の案内も<br />スマートに。</h3>
                <p>Beengoを使えば、もう何人もの参加メンバーとたくさんのメールを交わす必要はありません。「日時決定」の操作を施せば、「イベントページ」がそのまま、会場や待ち合わせ場所の地図（Googleマップ）付きの案内状になります。</p>
                <p>案内文や「イベントページ」へのリンクは、Beengo上から自動的にメール本文に挿入させたり、FacebookやGoogle+、LINE（スマホのみ対応）で簡単に共有することもできます。</p>
            </div><!--<appeal_box>-->
            <div class="appeal_box shadow">
                ...
                <p>使い方も簡単。説明に従って入力、操作していけば、数ステップで完了します。ぜひ一度、お気軽に試してみてください。</p>
    ...
    <div id="create_event_h">
        ...
        <form action="create.php" method="post">
            ...
            <div class="input_part">
                <input type="text" name="title" id="title" class="input_text required" value="" />
            </div>

            <div class="input_part">
                <textarea name="description" id="description" class="textarea" rows="10" cols="40"></textarea>
            </div>
            ...
            <div class="input_part">
                <input type="text" name="master_name" id="master_name" class="input_text required" value="" />
                <p class="input_note">本名フルネームを入力する必要はありませんが、参加メンバーがあなただとわかる名前を入力してあげてください。</p>
            </div>
            
            <div class="input_part">
                <input type="text" name="pass" id="pass" class="input_text byte_alphanumeric" />
                ...
                <input type="text" name="pass2" id="pass2" class="input_text" />
            </div>
